export default {
  common: {
    ...
    setIndexMessage: 'Are you sure to set it as the homepage？',
    setStateOnMessage: 'Are you sure to open the page?',
    setStateOffMessage: 'Are you sure to close the page?',
  },
  error: {
