  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="收货人所在省" prop="province">
        <el-input v-model="formData.province" placeholder="请输入收货人所在省" />
      </el-form-item>
...
const formRules = reactive({
  ...
  province: [{ required: true, message: '收货人所在省不能为空', trigger: 'blur' }],
  city: [{ required: true, message: '收货人所在市不能为空', trigger: 'blur' }],
  district: [{ required: true, message: '收货人所在区不能为空', trigger: 'blur' }],
