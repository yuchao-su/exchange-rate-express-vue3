...
/** 打开弹窗 */
const open = async (type: string, row?: TagGroupApi.TagGroupVO) => {
...
const submitForm = async () => {
  ...
  try {
    const data = formData.value as unknown as TagGroupApi.TagGroupVO
    if (formType.value === 'create') {
      await TagGroupApi.createTagGroup(data)
      message.success(t('common.createSuccess'))
    } else {
      await TagGroupApi.updateTagGroup(data)
