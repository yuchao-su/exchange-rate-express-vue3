<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" style="width: 100%">
      ...
      <el-table-column label="秒杀订单" align="center" prop="orderQuantity"  />
      <el-table-column label="秒杀销售额" align="center" prop="salesAmount"  />
      <el-table-column label="秒杀销量" align="center" prop="salesQuantity"  />
  ...
  <!-- 表单弹窗：添加/修改 -->
  <SeckillForm ref="formRef" @success="getList"/>
...
import SeckillForm from "@/views/marketing/seckill/seckillForm.vue";
