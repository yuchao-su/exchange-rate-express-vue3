...
<!--      </el-form-item>-->
      ...
      <div class="select-product">
        ...
        <div class="title flex">
          <div class="group-goods"><b>*</b>秒杀商品</div>
          ...
          <div class="tableBox">
            ...
            >
              ...
              <el-table-column
                ...
                label="库存"
              />
              <el-table-column label="秒杀价" width="180" align="center">
                <template #default="scope">
  ...
  for (let product of selectProductList.value) {
    if (product.specType === 1) {
      ...
      if (product.skus[0].price <=0 || product.skus[0].stock <=0) {
        message.error(`${product.storeName}该商品秒杀价或库存必须大于0`)
        return false;
      }
    }
  }
