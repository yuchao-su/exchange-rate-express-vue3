<template>
  <div class="brandListTool">
    ...
    <div
      v-if="activeComponent.componentContent.imgTextData.length < 20"
      class="addImgBtn"
      @click="addImgText"
    >
      <span class="iconfont">&#xe64a;</span>添加导航
    </div>
    <div v-else class="addImgBtn">
      <span class="iconfont">&#xe608;</span>最多只能添加20个
    </div>
  </div>
</template>
